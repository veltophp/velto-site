...
@section('title')
    Blog Post by {{$post->topic}} | VeltoPHP
@endsection
...
@section('content')
    <div class="container mx-auto px-4 py-36 max-w-6xl">
        <!-- Popular Category -->
        <div class="mb-20">
            <h2 class="text-2xl font-light text-gray-900 dark:text-white mb-8 border-b border-gray-200 dark:border-gray-700 pb-2">Explore Post Articles by {{$post->topic}} </h2>
