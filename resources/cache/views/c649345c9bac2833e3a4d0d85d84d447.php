...
<div class="min-h-screen flex flex-col md:flex-row bg-white dark:bg-gray-900">
    ...
    <div class="md:w-1/2 flex items-center justify-center p-8 md:p-12 lg:p-24">
        <div class="w-full max-w-md mt-12">
            ...
            <!-- Flash -->
            <div class="mt-4"><?php echo flash()->display('#form-forgot-password'); ?></div>

            <!-- Form -->
            <form id="form-forgot-password" action="<?php echo htmlspecialchars((string)(route('submit.forgot.password')), ENT_QUOTES, 'UTF-8'); ?>" method="POST" class="space-y-6">
                <?= csrf_field() ?>
            ...
            <div class="mt-8 text-center">
                <p class="text-gray-600 dark:text-gray-400">
                    ...
                    <a href="<?php echo htmlspecialchars((string)(route('login')), ENT_QUOTES, 'UTF-8'); ?>" class="text-red-600 dark:text-red-400 font-medium hover:underline">
                        Login
                    </a>
                </p>
            </div>
