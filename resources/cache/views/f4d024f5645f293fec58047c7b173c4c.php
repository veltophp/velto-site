...
<div class="bg-white">
    <div class="max-w-7xl mx-auto px-6 md:px-9 py-12">
        ...
        <div class="mb-12 border-b pb-8 max-w-lg">
            <form action="<?php echo htmlspecialchars((string)(route('logout')), ENT_QUOTES, 'UTF-8'); ?>" method="POST" class="space-y-4">
                <?= csrf_field() ?>
                <button type="submit"
        ...
        <div class="mb-12 border-b pb-8 max-w-lg">
            ...
            <div class="mt-4"><?php echo flash()->display('#form-update-name'); ?></div>

            <form id="form-update-name" 
                action="<?php echo htmlspecialchars((string)(route('axion.update.name')), ENT_QUOTES, 'UTF-8'); ?>" 
                ...
                <div>
                    ...
                    <input type="text" name="name" id="name" value="<?php echo htmlspecialchars((string)(Auth::user()->name), ENT_QUOTES, 'UTF-8'); ?>"
                ...
                <div>
                    ...
                    <input type="email" value="<?php echo htmlspecialchars((string)(Auth::user()->username), ENT_QUOTES, 'UTF-8'); ?>" disabled
                ...
                <div>
                    ...
                    <input type="email" value="<?php echo htmlspecialchars((string)(Auth::user()->email), ENT_QUOTES, 'UTF-8'); ?>" disabled
                        class="mt-1 block w-full bg-gray-100 border border-gray-300 rounded-md shadow-sm px-3 py-2 font-thin text-gray-500 cursor-not-allowed">
                </div>
        ...
        <div class="mb-12 border-b pb-8 max-w-lg">
            ...
            <div class="mt-4"><?php echo flash()->display('#form-change-password'); ?></div>


            <form id="form-change-password" 
                action="<?php echo htmlspecialchars((string)(route('axion.change.password')), ENT_QUOTES, 'UTF-8'); ?>" 
                method="POST" 
        ...
        <div class="mb-12 border-b pb-8 max-w-lg">
            ...
            <div class="mt-4"> <?php echo flash()->display('#form-delete-account'); ?> </div>

            <form id="form-delete-account" 
                action="<?php echo htmlspecialchars((string)(route('delete.account')), ENT_QUOTES, 'UTF-8'); ?>" 
                method="POST" 
