        ...
        <div class="flex justify-between h-16 items-center">
            ...
            <div class="flex items-center space-x-4">
                ...
                <div class="hidden sm:flex space-x-6">
                    ...
                    <a href="<?php echo htmlspecialchars((string)(route('axion.example.page')), ENT_QUOTES, 'UTF-8'); ?>"
                       class="<?php echo active('/axion/example-page', 'border-red-500'); ?> inline-flex items-center px-1 pt-1 border-b-2 text-gray-500 hover:text-red-600 hover:border-red-400">
                        Example Page
                    </a>
                </div>
            </div>
